...
folder_output = 'python_visualization_multicase_v01'  # folder for the output figures.
...
def Draw_figures(file_insta, file_land, file_rad, file_prof, file_tseries):
    """
    ...
    pbl = z_mc[np.argmin(wth[48, :])]  # Let's assume the time 6h.
...
Draw_figures(file_insta, file_land, file_rad, file_prof, file_tseries)
